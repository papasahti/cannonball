...
DEFAULT_USER_LOGIN="${CANNONBALL_APP_USER_USERNAME:-operator1}"
DEFAULT_USER_NAME="${CANNONBALL_APP_USER_DISPLAY_NAME:-Operator One}"
DEFAULT_USER_EMAIL="${CANNONBALL_APP_USER_EMAIL:-operator1@example.com}"
DEFAULT_USER_PASSWORD="${CANNONBALL_APP_USER_PASSWORD:-operator123}"
...
if [[ -n "${CANNONBALL_PUBLIC_URL:-}" ]]; then
...
APP_USER_USERNAME=${DEFAULT_USER_LOGIN}
APP_USER_DISPLAY_NAME=${DEFAULT_USER_NAME}
APP_USER_EMAIL=${DEFAULT_USER_EMAIL}
APP_USER_PASSWORD=${DEFAULT_USER_PASSWORD}
APP_FORCE_BOOTSTRAP_USER_PASSWORD_SYNC=true
...
prepare_runtime_files() {
  ...
  set_env_value "${INSTALL_DIR}/.env" "APP_USER_USERNAME" "${DEFAULT_USER_LOGIN}"
  set_env_value "${INSTALL_DIR}/.env" "APP_USER_DISPLAY_NAME" "${DEFAULT_USER_NAME}"
  set_env_value "${INSTALL_DIR}/.env" "APP_USER_EMAIL" "${DEFAULT_USER_EMAIL}"
  set_env_value "${INSTALL_DIR}/.env" "APP_USER_PASSWORD" "${DEFAULT_USER_PASSWORD}"
  set_env_value "${INSTALL_DIR}/.env" "APP_USER_PASSWORD_HASH" ""
  set_env_value "${INSTALL_DIR}/.env" "APP_FORCE_BOOTSTRAP_USER_PASSWORD_SYNC" "true"
...
Логин пользователя: ${DEFAULT_USER_LOGIN}
Пароль пользователя: ${DEFAULT_USER_PASSWORD}
