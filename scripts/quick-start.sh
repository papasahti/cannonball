...
APP_USER_USERNAME="${CANNONBALL_APP_USER_USERNAME:-operator1}"
APP_USER_DISPLAY_NAME="${CANNONBALL_APP_USER_DISPLAY_NAME:-Operator One}"
APP_USER_EMAIL="${CANNONBALL_APP_USER_EMAIL:-operator1@example.com}"
...
APP_USER_PASSWORD="${CANNONBALL_APP_USER_PASSWORD:-operator123}"
...
docker run -d \
  ...
  -e APP_USER_USERNAME="$APP_USER_USERNAME" \
  -e APP_USER_DISPLAY_NAME="$APP_USER_DISPLAY_NAME" \
  -e APP_USER_EMAIL="$APP_USER_EMAIL" \
  -e APP_USER_PASSWORD="$APP_USER_PASSWORD" \
  -e APP_FORCE_BOOTSTRAP_USER_PASSWORD_SYNC=true \
...
echo "User login: $APP_USER_USERNAME"
echo "User password: $APP_USER_PASSWORD"
echo
